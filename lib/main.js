    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!titleMatchesRegex) {
            ...
            if (verfiyHeadCommitMessage) {
                ...
                const commit = yield getCommitBySha({
                    owner: pullRequest.owner,
                    repo: pullRequest.repo,
                    sha: headSha,
                });
                core.debug(`commit-message ${commit.message}`);
                const messageMatchesRegex = titleRegex.test(commit.message);
...
function getPullRequestHeadSha(pullRequest) {
    return __awaiter(this, void 0, void 0, function* () {
...
function getCommitBySha(commit) {
    return __awaiter(this, void 0, void 0, function* () {
